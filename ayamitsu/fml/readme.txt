...
既存書き換えはcoremods形式にすることによってminecraft.jarに直接いれなくてもいいように改善。
更にFMLのdeobfuscationの影響で難読化を気にしないでいいようになりました。
...
2.このMODのzipの中の"GoreModPlugin"をcoremodsにいれ、"GoreMod"をmodsにいれる。
3.完了
